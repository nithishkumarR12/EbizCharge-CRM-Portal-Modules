...
class UploadCreditNoteButtons extends ListRenderer {
    ...
    async UploadCreditNoteUpload (ev) {
            ...
            const params = Object.fromEntries(
             ...
             const action = await rpc("/web/dataset/call_kw/upload.credit.notes/upload_invoice", {
    ...
    async UploadCreditNoteExportList (ev) {
            ...
            const params = Object.fromEntries(
             ...
             const action = await rpc("/web/dataset/call_kw/upload.credit.notes/export_orders", {
                model: 'upload.credit.notes',
    ...
    async UploadCreditNoteClearLogs (ev) {
            ...
            const params = Object.fromEntries(
             ...
             const action = await rpc("/web/dataset/call_kw/upload.credit.notes/clear_logs", {
                model: 'upload.credit.notes',
                method: 'clear_logs',
                args : [[parseInt(params['id'])]],
                kwargs: {"values":res_ids}
    ...
    async UploadCreditNoteExportLogs (ev) {
            ...
            const params = Object.fromEntries(
             ...
             const action = await rpc("/web/dataset/call_kw/upload.credit.notes/export_logs", {
                model: 'upload.credit.notes',
                method: 'export_logs',
                args : [[parseInt(params['id'])]],
                kwargs: {"values":res_ids}
