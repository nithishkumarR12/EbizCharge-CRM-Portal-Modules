...
class SalePaymentLinkEBiz extends ListRenderer {
    ...
    async showSoExport (ev) {
            ...
            const params = Object.fromEntries(
             ...
             const action = await rpc("/web/dataset/call_kw/sale.order.payment.link.bulk/export_sale_order", {
    ...
    async removeSoPaylink (ev) {
            ...
            const params = Object.fromEntries(
             ...
             const action = await rpc("/web/dataset/call_kw/sale.order.payment.link.bulk/action_remove_payment_link", {
                model: 'sale.order.payment.link.bulk',
    ...
    async generateSoPaylink (ev) {
            ...
            const params = Object.fromEntries(
             ...
             const action = await rpc("/web/dataset/call_kw/sale.order.payment.link.bulk/action_generate_payment_link", {
                model: 'sale.order.payment.link.bulk',
