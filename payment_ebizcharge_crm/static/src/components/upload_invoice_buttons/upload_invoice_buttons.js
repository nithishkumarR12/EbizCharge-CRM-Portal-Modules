   ...
   toggleRecordSelection(record) {
    ...
    async UploadInvoiceUpload (ev) {
            ...
            const params = Object.fromEntries(
             ...
             const action = await rpc("/web/dataset/call_kw/ebiz.upload.invoice/upload_invoice", {
    ...
    async UploadInvoiceExportList (ev) {
            ...
            const params = Object.fromEntries(
             ...
             const action = await rpc("/web/dataset/call_kw/ebiz.upload.invoice/export_orders", {
                model: 'ebiz.upload.invoice',
    ...
    async UploadInvoiceClearLogs (ev) {
            ...
            const params = Object.fromEntries(
             ...
             const action = await rpc("/web/dataset/call_kw/ebiz.upload.invoice/clear_logs", {
                model: 'ebiz.upload.invoice',
                method: 'clear_logs',
                args : [[parseInt(params['id'])]],
                kwargs: {"values":res_ids}
    ...
    async UploadInvoiceExportLogs (ev) {
            ...
            const params = Object.fromEntries(
             ...
             const action = await rpc("/web/dataset/call_kw/ebiz.upload.invoice/export_logs", {
                model: 'ebiz.upload.invoice',
                method: 'export_logs',
                args : [[parseInt(params['id'])]],
                kwargs: {"values":res_ids}
